          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            <div className="lg:col-span-5 space-y-6">
              <div className="space-y-3">
                ...
                <h2 className="font-serif text-2xl md:text-4xl font-bold text-[#211711] leading-tight">
                  Built for Florida homes & discerning owners.
                </h2>
                <p className="text-sm text-[#6a594c] leading-relaxed font-medium">
              ...
              <Accordion type="single" collapsible defaultValue="item-0" className="w-full border-t border-[#211711]/15">
                {whyUs.map((item, idx) => (
              ...
              <div className="pt-2 flex items-center gap-2.5 text-[11px] font-bold uppercase tracking-widest text-[#211711]/60">
                <span className="w-2 h-2 rounded-full bg-[#c2592e]"></span>
                <span>Family Owned & Operated • Suncoast, FL</span>
              </div>
            </div>

            <div className="lg:col-span-7 bg-[#211711] text-white p-7 md:p-10 rounded-sm shadow-xl flex flex-col justify-between overflow-hidden">
              ...
              <div className="-mx-7 -mb-7 md:-mx-10 md:-mb-10 p-5 md:p-6 bg-[#c2592e] text-white text-sm font-bold tracking-wide flex items-center gap-3.5 border-t border-white/10">
